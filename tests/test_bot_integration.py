...
@pytest.mark.asyncio
async def test_on_ready_syncs_command_tree_only_once(monkeypatch, config_store):
    ...
    client = create_bot(GUILD_ID, config_store)
